...
namespace YOGA.Modules.OdinToolkits.Scripts.Editor
{
    public static class UnityEditorAPIOverviewUtil
    {
        ...
        public static UnityEditorAPIOverviewDatabase OverviewDatabase
        {
            get
            {
                var database = ProjectEditorUtility.SO
                    .GetScriptableObjectDeleteExtra<UnityEditorAPIOverviewDatabase>(
                        OdinToolkitsPaths.GetRootPath() + "/" + "Tools/UnityEditorAPIOverview/Database" +
        ...
        static Assembly[] GetSirenixAllAssemblies()
        {
            ...
            return ReflectionUtilities.GetAssembliesOfNameContainString(sirenixAssemblyName);
        }
        ...
        public static HashSet<string> GetTotalNamespaceCountInSirenixEditorAssemblies()
        {
            ...
            {
                var namespaces = ReflectionUtilities.GetNamespacesInAssembly(assembly);
